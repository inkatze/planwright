...
- **Lens-coverage table.** Recorded artifact-side, in full, in the brief
  section the sign-off record closes; the turn carries its counts plus the
  notable rows (`interaction-style`, the arbitration).
