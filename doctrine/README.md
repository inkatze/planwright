...
| [kickoff-verification.md](kickoff-verification.md) | The `/spec-kickoff` sign-off verification gates whose mechanics are lifted out of the skill body: the terminal ready-flip CI gate (head-SHA rollup query, positive-green condition, bounded wait, head re-pin, refusal arm) | skill-rigor REQ-B1.1 · skill-rigor D-3 |
