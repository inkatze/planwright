...
worktree, and task-id grammar*, where it binds `/execute-task`, the skill that
loads that doc. This section is the worked explanation, and it extends the same
convention to commits nothing enforces it on: manual and solo ones.
