...
# `**Task <token>**`, column-0 fences treated as illustration
# (doctrine/spec-format.md, *Fenced illustration*) and section headings matched
# CRLF-tolerantly, so a fenced mock bullet parks nothing and a
