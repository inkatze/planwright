...
decision, rows 7–9 are recorded execution notes (T5 dependency-adoption, T6
window-lock base-reading, T10 armed-mode watch/delegate), all rows carry
mitigation and early signal. Data hygiene checked: no secrets, hostnames, or
