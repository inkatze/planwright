...
declared-exception|skills/bt/SKILL.md|1|accepted: this body is intentionally near its budget
EOF
out="$(/bin/bash "$CHECKER" --root "$t15d" 2>&1)"
...
declared-exception|skills/bt/SKILL.md|1|attempting (and failing) to excuse a floor-breach
EOF
...
declared-exception|skills/nowhere/SKILL.md|1|nothing here warns
EOF
