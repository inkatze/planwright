...
# the same commit.
expected_deny='["Bash(gh pr merge:*)","Bash(gh pr ready:*)","Bash(git merge:*)","Bash(git rebase:*)","Bash(git commit --amend:*)","Bash(git commit --squash:*)","Bash(git commit --fixup:*)","Bash(git reset --hard:*)","Bash(git filter-branch:*)","Bash(git filter-repo:*)","Bash(git branch -f:*)","Bash(git branch --force:*)","Bash(git update-ref:*)","Bash(git worktree add --force:*)","Bash(git worktree add -f:*)","Bash(git worktree add * --force*)","Bash(git worktree add * -f*)","Bash(git worktree add --detach:*)","Bash(git worktree add * --detach*)","Bash(git worktree add -b main:*)","Bash(git worktree add * -b main*)","Bash(git worktree add * main)","Bash(git worktree add * main *)","Bash(git worktree add *refs/heads/main)","Bash(git worktree add *refs/heads/main *)","Bash(git worktree add *heads/main)","Bash(git worktree add *heads/main *)","Bash(git worktree add *origin/main)","Bash(git worktree add *origin/main *)","Bash(git worktree remove --force:*)","Bash(git worktree remove -f:*)","Bash(git worktree remove * --force*)","Bash(git worktree remove * -f*)","Bash(git worktree move * --force*)","Bash(git worktree move --force:*)","Bash(git push --force:*)","Bash(git push --force-with-lease:*)","Bash(git push --force-with-lease=*)","Bash(git push -f:*)","Bash(git push * --force*)","Bash(git push * -f*)","Bash(git push *+*)","Bash(git push *:main)","Bash(git push *:main *)","Bash(git push * main)","Bash(git push * main *)","Bash(git push *refs/heads/main)","Bash(git push *heads/main)","Bash(git push *heads/main *)","Bash(git push --mirror:*)","Bash(git push * --mirror*)","Bash(git push --all:*)","Bash(git push * --all*)","Bash(git -c * push:*)","mcp__github__merge_pull_request","mcp__github__update_pull_request","mcp__github__push_files","mcp__github__create_or_update_file","mcp__github__delete_file"]'
